...
import com.alam.eathub.Common.DirectionJSONParser;
import com.alam.eathub.Model.Request;
import com.alam.eathub.Model.ShippingInformation;
...
public class TrackOrderActivity extends FragmentActivity implements OnMapReadyCallback,ValueEventListener {
    ...
    //make request fill values when order is placed in placeorder activity
...
*/
                ...
                shippingOrder.child(Common.currentKey).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (ActivityCompat.checkSelfPermission(TrackOrderActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(TrackOrderActivity.this, new String[]{Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
                        }
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        AlertDialog mDialog = new SpotsDialog.Builder().setContext(TrackOrderActivity.this).setCancelable(false).build();
